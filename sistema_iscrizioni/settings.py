"""
Django settings for sistema_iscrizioni project.
...
SECRET_KEY = 'django-insecure-g75$q8v)nxk9v%4jz3j=-^xve=b$)tn#z=%16vq$a%)-22p625'
...
ROOT_URLCONF = 'sistema_iscrizioni.urls'
...
WSGI_APPLICATION = 'sistema_iscrizioni.wsgi.application'
...
LOGIN_URL = 'login'
LOGIN_REDIRECT_URL = 'centri_list'
